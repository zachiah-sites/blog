...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-41ac5eed.js",
      css: ["/./_app/assets/start-a8cd1609.css"],
      js: ["/./_app/start-41ac5eed.js", "/./_app/chunks/vendor-ad960fc4.js", "/./_app/chunks/preload-helper-9f12a5fd.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-bd676911.js", "css": ["/./_app/assets/pages/__layout.svelte-292d1a97.css"], "js": ["/./_app/pages/__layout.svelte-bd676911.js", "/./_app/chunks/vendor-ad960fc4.js"], "styles": null }, "src/routes/__error.svelte": { "entry": "/./_app/pages/__error.svelte-cee44129.js", "css": ["/./_app/assets/Card-a712499c.css"], "js": ["/./_app/pages/__error.svelte-cee44129.js", "/./_app/chunks/vendor-ad960fc4.js", "/./_app/chunks/Card-d2511efd.js"], "styles": null }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-d9591eba.js", "css": ["/./_app/assets/Card-a712499c.css"], "js": ["/./_app/pages/index.svelte-d9591eba.js", "/./_app/chunks/vendor-ad960fc4.js", "/./_app/chunks/Card-d2511efd.js", "/./_app/chunks/PostHOC-a627cb8a.js", "/./_app/chunks/preload-helper-9f12a5fd.js"], "styles": null }, "src/routes/posts/[id].svelte": { "entry": "/./_app/pages/posts/[id].svelte-5069f0a8.js", "css": ["/./_app/assets/Card-a712499c.css"], "js": ["/./_app/pages/posts/[id].svelte-5069f0a8.js", "/./_app/chunks/vendor-ad960fc4.js", "/./_app/chunks/PostHOC-a627cb8a.js", "/./_app/chunks/preload-helper-9f12a5fd.js", "/./_app/chunks/Card-d2511efd.js"], "styles": null } };
...
var css$5 = {
  code: ".wrapper.svelte-x5foda{display:grid;grid-template-columns:1fr;grid-template-rows:1fr}.inner.svelte-x5foda{grid-area:1 / 1 / 1 / 1}.inner-inner.svelte-x5foda{position:relative}",
  map: '{"version":3,"file":"PageTransition.svelte","sources":["PageTransition.svelte"],"sourcesContent":["<script>\\r\\n\\texport let refresh = \'\';\\r\\n\\r\\n\\tfunction fly(node, { delay = 0, duration = 400 }) {\\r\\n\\t\\treturn {\\r\\n\\t\\t\\tdelay,\\r\\n\\t\\t\\tduration,\\r\\n\\t\\t\\tcss: (t) => `left: ${0 - t * 500}px;opacity: ${t}`\\r\\n\\t\\t};\\r\\n\\t}\\r\\n<\/script>\\r\\n\\r\\n<div class=\\"wrapper\\">\\r\\n\\t{#key refresh}\\r\\n\\t\\t<div class=\\"inner\\">\\r\\n\\t\\t\\t<div class=\\"inner-inner\\" out:fly|local={{ duration: 500 }} in:fly|local={{ duration: 500 }}>\\r\\n\\t\\t\\t\\t<slot />\\r\\n\\t\\t\\t</div>\\r\\n\\t\\t</div>\\r\\n\\t{/key}\\r\\n</div>\\r\\n\\r\\n<style>\\r\\n\\t.wrapper {\\r\\n\\t\\tdisplay: grid;\\r\\n\\t\\tgrid-template-columns: 1fr;\\r\\n\\t\\tgrid-template-rows: 1fr;\\r\\n\\t}\\r\\n\\r\\n\\t.inner {\\r\\n\\t\\tgrid-area: 1 / 1 / 1 / 1;\\r\\n\\t}\\r\\n\\t.inner-inner {\\r\\n\\t\\tposition: relative;\\r\\n\\t}\\r\\n</style>\\r\\n"],"names":[],"mappings":"AAuBC,QAAQ,cAAC,CAAC,AACT,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,GAAG,CAC1B,kBAAkB,CAAE,GAAG,AACxB,CAAC,AAED,MAAM,cAAC,CAAC,AACP,SAAS,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,AACzB,CAAC,AACD,YAAY,cAAC,CAAC,AACb,QAAQ,CAAE,QAAQ,AACnB,CAAC"}'
};
create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"wrapper svelte-x5foda"}"><div class="${"inner svelte-x5foda"}"><div class="${"inner-inner svelte-x5foda"}">${slots.default ? slots.default({}) : ``}</div></div>
</div>`;
});
var css$4 = {
  code: "nav.svelte-176luxs{display:contents}ul.svelte-176luxs{display:flex;padding:1em;gap:1em;background:#3f51b5;color:white;position:sticky;top:0;box-shadow:0 0 10px rgba(0, 0, 0, 0.8)}li.svelte-176luxs:first-of-type{margin-right:auto}main.svelte-176luxs{margin:0 1em}",
  map: `{"version":3,"file":"__layout.svelte","sources":["__layout.svelte"],"sourcesContent":["<script lang=\\"ts\\">import PageTransition from '../components/PageTransition.svelte';\\r\\nimport '../globals.css';\\r\\n<\/script>\\n\\n<nav>\\n\\t<ul>\\n\\t\\t<li><a href=\\"/\\">Home</a></li>\\n\\t\\t<li><a href=\\"/archives\\">Archives</a></li>\\n\\t\\t<li><a href=\\"/about\\">About</a></li>\\n\\t</ul>\\n</nav>\\n\\n<main>\\n\\t<slot />\\n</main>\\n\\n<style>\\n\\tnav {\\n\\t\\tdisplay: contents;\\n\\t}\\n\\tul {\\n\\t\\tdisplay: flex;\\n\\t\\tpadding: 1em;\\n\\t\\tgap: 1em;\\n\\t\\tbackground: #3f51b5;\\n\\t\\tcolor: white;\\n\\t\\tposition: sticky;\\n\\t\\ttop: 0;\\n\\t\\tbox-shadow: 0 0 10px rgba(0, 0, 0, 0.8);\\n\\t}\\n\\n\\tli:first-of-type {\\n\\t\\tmargin-right: auto;\\n\\t}\\n\\n\\tmain {\\n\\t\\tmargin: 0 1em;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AAiBC,GAAG,eAAC,CAAC,AACJ,OAAO,CAAE,QAAQ,AAClB,CAAC,AACD,EAAE,eAAC,CAAC,AACH,OAAO,CAAE,IAAI,CACb,OAAO,CAAE,GAAG,CACZ,GAAG,CAAE,GAAG,CACR,UAAU,CAAE,OAAO,CACnB,KAAK,CAAE,KAAK,CACZ,QAAQ,CAAE,MAAM,CAChB,GAAG,CAAE,CAAC,CACN,UAAU,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,AACxC,CAAC,AAED,iBAAE,cAAc,AAAC,CAAC,AACjB,YAAY,CAAE,IAAI,AACnB,CAAC,AAED,IAAI,eAAC,CAAC,AACL,MAAM,CAAE,CAAC,CAAC,GAAG,AACd,CAAC"}`
};
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$4);
  return `<nav class="${"svelte-176luxs"}"><ul class="${"svelte-176luxs"}"><li class="${"svelte-176luxs"}"><a href="${"/"}">Home</a></li>
		<li class="${"svelte-176luxs"}"><a href="${"/archives"}">Archives</a></li>
		<li class="${"svelte-176luxs"}"><a href="${"/about"}">About</a></li></ul></nav>

<main class="${"svelte-176luxs"}">${slots.default ? slots.default({}) : ``}
</main>`;
});
...
var css = {
  code: ".title.svelte-1eb97ee.svelte-1eb97ee{margin-right:auto}.card.svelte-1eb97ee.svelte-1eb97ee{background:var(--main-bg);color:var(--main-color);margin:1em 0 1em calc(1em * calc(var(--level) - 1));box-shadow:0 0 15px 7px black;position:relative}.content.svelte-1eb97ee.svelte-1eb97ee{padding:1em;position:relative}.link.svelte-1eb97ee .content.svelte-1eb97ee{max-height:20em;overflow:hidden}.inner.svelte-1eb97ee.svelte-1eb97ee{display:none}.link.svelte-1eb97ee .inner.svelte-1eb97ee{display:block;position:absolute;top:0;bottom:0;left:0;right:0;background:linear-gradient(180deg, transparent 60%, black)}a.svelte-1eb97ee.svelte-1eb97ee{display:block;position:absolute;top:0;bottom:0;left:0;right:0;opacity:0}",
  map: `{"version":3,"file":"Card.svelte","sources":["Card.svelte"],"sourcesContent":["<script lang=\\"ts\\">import { createEventDispatcher } from 'svelte';\\r\\nimport { slide } from 'svelte/transition';\\r\\nimport CardHeading from './CardHeading.svelte';\\r\\nimport ChevronDownIcon from './ChevronDownIcon.svelte';\\r\\nimport ChevronUpIcon from './ChevronUpIcon.svelte';\\r\\nexport let title;\\r\\nexport let link = undefined;\\r\\nexport let header = false;\\r\\nexport let level = 2;\\r\\nexport let collapsable = false;\\r\\nexport let collapsed = false;\\r\\nconst dispatch = createEventDispatcher();\\r\\n<\/script>\\r\\n\\r\\n<div class=\\"card\\" class:link class:normal={!link} style=\\"--level: {level}\\">\\r\\n\\t<CardHeading {level}>\\r\\n\\t\\t<span class=\\"title\\">{title}</span>\\r\\n\\t\\t{#if collapsable}\\r\\n\\t\\t\\t<button\\r\\n\\t\\t\\t\\ton:click={() => {\\r\\n\\t\\t\\t\\t\\tcollapsed = !collapsed;\\r\\n\\t\\t\\t\\t\\tdispatch('click');\\r\\n\\t\\t\\t\\t}}\\r\\n\\t\\t\\t>\\r\\n\\t\\t\\t\\t{#if collapsed}\\r\\n\\t\\t\\t\\t\\t<ChevronDownIcon />\\r\\n\\t\\t\\t\\t{:else}\\r\\n\\t\\t\\t\\t\\t<ChevronUpIcon />\\r\\n\\t\\t\\t\\t{/if}\\r\\n\\t\\t\\t</button>\\r\\n\\t\\t{/if}\\r\\n\\t</CardHeading>\\r\\n\\r\\n\\t{#if !header && !collapsed}\\r\\n\\t\\t<div class=\\"content\\" transition:slide|local>\\r\\n\\t\\t\\t<slot />\\r\\n\\t\\t\\t<div class=\\"inner\\">\\r\\n\\t\\t\\t\\t<a href={link}>{title}</a>\\r\\n\\t\\t\\t</div>\\r\\n\\t\\t</div>\\r\\n\\t{/if}\\r\\n</div>\\r\\n\\r\\n<style>\\r\\n\\t.title {\\r\\n\\t\\tmargin-right: auto;\\r\\n\\t}\\r\\n\\t.card {\\r\\n\\t\\tbackground: var(--main-bg);\\r\\n\\t\\tcolor: var(--main-color);\\r\\n\\t\\tmargin: 1em 0 1em calc(1em * calc(var(--level) - 1));\\r\\n\\t\\tbox-shadow: 0 0 15px 7px black;\\r\\n\\t\\tposition: relative;\\r\\n\\t}\\r\\n\\r\\n\\t.content {\\r\\n\\t\\tpadding: 1em;\\r\\n\\t\\tposition: relative;\\r\\n\\t}\\r\\n\\r\\n\\t.link .content {\\r\\n\\t\\tmax-height: 20em;\\r\\n\\t\\toverflow: hidden;\\r\\n\\t}\\r\\n\\r\\n\\t.inner {\\r\\n\\t\\tdisplay: none;\\r\\n\\t}\\r\\n\\r\\n\\t.link .inner {\\r\\n\\t\\tdisplay: block;\\r\\n\\t\\tposition: absolute;\\r\\n\\t\\ttop: 0;\\r\\n\\t\\tbottom: 0;\\r\\n\\t\\tleft: 0;\\r\\n\\t\\tright: 0;\\r\\n\\t\\tbackground: linear-gradient(180deg, transparent 60%, black);\\r\\n\\t}\\r\\n\\r\\n\\ta {\\r\\n\\t\\tdisplay: block;\\r\\n\\t\\tposition: absolute;\\r\\n\\t\\ttop: 0;\\r\\n\\t\\tbottom: 0;\\r\\n\\t\\tleft: 0;\\r\\n\\t\\tright: 0;\\r\\n\\t\\topacity: 0;\\r\\n\\t}\\r\\n</style>\\r\\n"],"names":[],"mappings":"AA4CC,MAAM,8BAAC,CAAC,AACP,YAAY,CAAE,IAAI,AACnB,CAAC,AACD,KAAK,8BAAC,CAAC,AACN,UAAU,CAAE,IAAI,SAAS,CAAC,CAC1B,KAAK,CAAE,IAAI,YAAY,CAAC,CACxB,MAAM,CAAE,GAAG,CAAC,CAAC,CAAC,GAAG,CAAC,KAAK,GAAG,CAAC,CAAC,CAAC,KAAK,IAAI,OAAO,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CACpD,UAAU,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,GAAG,CAAC,KAAK,CAC9B,QAAQ,CAAE,QAAQ,AACnB,CAAC,AAED,QAAQ,8BAAC,CAAC,AACT,OAAO,CAAE,GAAG,CACZ,QAAQ,CAAE,QAAQ,AACnB,CAAC,AAED,oBAAK,CAAC,QAAQ,eAAC,CAAC,AACf,UAAU,CAAE,IAAI,CAChB,QAAQ,CAAE,MAAM,AACjB,CAAC,AAED,MAAM,8BAAC,CAAC,AACP,OAAO,CAAE,IAAI,AACd,CAAC,AAED,oBAAK,CAAC,MAAM,eAAC,CAAC,AACb,OAAO,CAAE,KAAK,CACd,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,MAAM,CAAE,CAAC,CACT,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,CAAC,CACR,UAAU,CAAE,gBAAgB,MAAM,CAAC,CAAC,WAAW,CAAC,GAAG,CAAC,CAAC,KAAK,CAAC,AAC5D,CAAC,AAED,CAAC,8BAAC,CAAC,AACF,OAAO,CAAE,KAAK,CACd,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,MAAM,CAAE,CAAC,CACT,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,CAAC,CACR,OAAO,CAAE,CAAC,AACX,CAAC"}`
};
var Card = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<div class="${["card svelte-1eb97ee", (link ? "link" : "") + " " + (!link ? "normal" : "")].join(" ").trim()}" style="${"--level: " + escape2(level)}">${validate_component(CardHeading, "CardHeading").$$render($$result, { level }, {}, {
    default: () => `<span class="${"title svelte-1eb97ee"}">${escape2(title)}</span>
	...
	${!header && !collapsed ? `<div class="${"content svelte-1eb97ee"}">${slots.default ? slots.default({}) : ``}
			<div class="${"inner svelte-1eb97ee"}"><a${add_attribute("href", link, 0)} class="${"svelte-1eb97ee"}">${escape2(title)}</a></div></div>` : ``}
</div>`;
});
...
function __variableDynamicImportRuntime0__(path) {
  switch (path) {
    case "../data/posts/box-shadow-button.svx":
      return Promise.resolve().then(function() {
        return boxShadowButton;
      });
    case "../data/posts/typography-guidlines.svx":
      return Promise.resolve().then(function() {
        return typographyGuidlines;
      });
    default:
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.postids === void 0 && $$bindings.postids && postids !== void 0)
    $$bindings.postids(postids);
  return `${validate_component(RecentPosts, "RecentPosts").$$render($$result, { postids }, {}, {})}`;
});
...
var metadata$1 = { "title": "Box Shadow Button" };
var Box_shadow_button = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return ``;
});
var boxShadowButton = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": Box_shadow_button,
  metadata: metadata$1
});
var metadata = { "title": "Typography Guidlines" };
var Typography_guidlines = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<h1>H1</h1>
<p>some text under the h1</p>
<h2>H2</h2>
<p>some text under the h2</p>
<h3>H3</h3>
<p>some text under the H3</p>
<h4>H4</h4>
<p>some text under the H4</p>
<h5>H5</h5>
<p>some text under the h5</p>
<h6>H6</h6>
<p>some text under the h6</p>`;
});
var typographyGuidlines = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": Typography_guidlines,
  metadata
});
